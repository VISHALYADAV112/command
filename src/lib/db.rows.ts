...
export type DbEntityType = OwnedBusinessRow<'entity_types'>
export type DbEntity = Omit<Row<'entities'>, 'user_id'>
export type DbEntityWrite = Omit<DbEntity, 'created_at' | 'updated_at'>
export type DbCommitment = OwnedBusinessRow<'commitments'>
export type DbActivityEvent = Omit<Row<'activity_events'>, 'user_id'>
export type DbAgentProposal = Omit<Row<'agent_proposals'>, 'user_id'>
